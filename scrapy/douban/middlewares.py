...
class SeleniumDownloadMiddleware(object):
    ...
    def process_request(self,request,spider):
        if  "https://movie.douban.com" in request.url and request.url != "https://movie.douban.com/tag/#/" and request.url != "https://movie.douban.com/tag/#/?sort=S":
            return None
        ...
        try:
            while True:
                if request.url != "https://www.jianshu.com/" and request.url != "https://movie.douban.com/tag/#/" and request.url != "https://movie.douban.com/tag/#/?sort=S":
                    break
                for i in range(1000):
...
class ProxyMiddleware(object):
    ...
    def process_request(self, request, spider):
        ...
        #request.meta['proxy'] = "58.218.214.141:2585"
